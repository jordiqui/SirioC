...
int SearchHistory::probcut_candidate_source_explicit_flags_count_for_tests() const {
    return probcut_runtime_counters_.candidate_source_explicit_flags_applied;
}
void SearchHistory::record_probcut_candidate_source_explicit_flags() {
    ++probcut_runtime_counters_.candidate_source_explicit_flags_applied;
}
...
int SearchHistory::probcut_empty_candidate_flags_count_for_tests() const {
    return probcut_runtime_counters_.empty_candidate_flags_applied;
}
...
void SearchHistory::record_probcut_non_empty_candidate_flags_probe() {
    ++probcut_runtime_counters_.non_empty_candidate_flags_probe_applied;
}
...
int SearchHistory::probcut_empty_reduced_search_request_count_for_tests() const {
    return probcut_runtime_counters_.empty_reduced_search_request_applied;
}
void SearchHistory::record_probcut_empty_reduced_search_request() {
    ++probcut_runtime_counters_.empty_reduced_search_request_applied;
}
int SearchHistory::probcut_empty_reduced_search_result_count_for_tests() const {
    return probcut_runtime_counters_.empty_reduced_search_result_applied;
}
